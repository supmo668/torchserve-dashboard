...
class YoloHandler(ObjectDetector):
    ...
    def initialize(self, context):
        ...
        self.model = self._load_model_fn(
            self.model_pt_path)
        logger.debug(
            "Model file %s loaded successfully", self.model_pt_path)

        self.initialized = True

    def _load_model_fn(self, model_pt_path):
